            ...
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
                    <div class="container-fluid">
                        <form method="get" action="<?php echo route('index')?>">
                            @csrf
                            <button class="btn btn" style="background-color: green;padding: 10px 20px;text-align: center;color: white;border-radius: 0px;font-family: Yekan">
                                باز گشت
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="ml-4 text-lg  uppercase tracking-wider" style="font-family: Yekan">
                        @yield('message')
                    </div>
