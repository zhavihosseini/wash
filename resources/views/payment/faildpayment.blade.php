...
<div class="container">
    <div class="row justify-content-center">
        <script>
            ...
            setTimeout(function(){
                window.location.href = 'https://paakwash.ir/my/shoppingcart';
            }, 10000);
        </script>
        ...
        <div class="col-12" style="margin-top: 15px;border: 1px solid grey;background-color: white">
            ...
            <p style="direction: rtl;text-align: center;color: red;font-weight: bold;font-size: 20px;font-family: Yekan">پرداخت انجام نشد</p>
            <div class="row">
            <p style="direction: rtl;text-align: right;color: red;font-weight: bold;font-size: 20px;font-family: Yekan"> شناسه پرداخت :  {{$trans}}</p>
            <p style="direction: rtl;text-align: right;color: red;font-weight: bold;font-size: 20px;font-family: Yekan"> کد خطا : {{$error}}</p>
                <p style="direction: rtl;text-align: right;color: red;font-weight: bold;font-size: 20px;font-family: Yekan"> شماره پرداخت : {{$orderid}}</p>
            </div>
        </div>
        <div class="container">
            <div class="col-md-12 text-center">
                <a href="<?php echo route('dashboard')?>" type="button" class="btn btn-success" style="margin-top: 10px;border-radius: 0px;font-family: Yekan;font-weight: bold">بازگشت</a>
            </div>
