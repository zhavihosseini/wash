<title>پاکیدو | تایید شماره تلفن همراه</title>
    ...
    <x-auth-card>
        ...
        <div class="card-body">
            ...
            @endif
                ...
                <br>
                <form method="POST" action="{{ route('sendverify') }}">
                @csrf

                <!-- Email Address -->
                    <div style="font-family: Yekan">
                        <x-input id="phone" placeholder="شماره تلفن خود را وارد کنید" class="block mt-1 w-full" style="text-align: center;font-weight: bold;font-family: Yekan;border-radius: 0px" type="text" name="phone" :value="old('phone')" required autofocus />
                    </div>
                    <br>
