...
<x-guest-layout>
    <x-auth-card>
        ...
        <!-- Validation Errors -->
            ...
            <!-- Email Address -->
                <div style="font-family: Yekan">
                    <x-input id="phone" placeholder="کد ارسال شده را وارد کنید" class="block mt-1 w-full" style="text-align: center;font-weight: bold;font-family: Yekan;border-radius: 0px" type="text" name="phone" :value="old('phone')" required autofocus />
                </div>
                <br>
        ...
        <form method="post" action="<?php echo route('resendverify')?>">
            @csrf
            ...
            <button id="bttn" class="col-md-12 text-center register-button" style="font-family: Yekan;border-radius: 0px;border: 1px solid lightgrey;background-color: white;color: black;width: 100%;margin-left: 0px;margin-top: 5px;text-align: center;font-size: 15px;padding: 7px">
                ...
                <form method="get" action="<?php echo route('changephones')?>">
                    @csrf
                    <input type="hidden" name="val">
                    <button id="bttn" class="col-md-12 text-center register-button" style="font-family: Yekan;border-radius: 0px;border: 1px solid lightgrey;background-color: white;color: black;width: 100%;margin-left: 0px;margin-top: 5px;text-align: center;font-size: 15px;padding: 7px">
                        تعویض شماره همراه
