<title>پاکیدو | فراموشی رمز عبور</title>
...
<x-guest-layout>
    <x-auth-card>
        ...
        <div class="mb-4 text-sm text-gray-600" style="direction: rtl;font-family: Yekan;font-weight: bold">
            رمز عبور خود را فراموش کرده اید؟ مشکلی نیست فقط آدرس ایمیل خود را به ما اطلاع دهید و ما یک پیوند تنظیم مجدد رمز عبور برای شما ارسال خواهیم کرد که به شما امکان می دهد پیوند جدیدی را انتخاب کنید.        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <!-- Email Address -->
            <div>
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus placeholder="ایمیل خود را وارد کنید" style="text-align: center;font-weight: bold;font-family: Yekan;border-radius: 0px" />
            </div>
