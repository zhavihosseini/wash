<title>پاکیدو | تغییر شماره تلفن</title>
...
<x-guest-layout>
    <x-auth-card>
        ...
        <!-- Validation Errors -->
            ...
            <br>
            <form method="POST" action="{{ route('savechangephones') }}">
            @csrf

            <!-- Email Address -->
                <div style="font-family: Yekan">
                    <x-input id="phone" placeholder="شماره تلفن جدید خود را وارد کنید" class="block mt-1 w-full" style="text-align: center;font-weight: bold;font-family: Yekan;border-radius: 0px" type="text" name="phone" :value="old('phone')" required autofocus />
                </div>
                <br>
