            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('ticket')}}">
                        ...
                        <span class="menu-title"><span style="font-family: BNazanin;margin:2px;color: red;font-weight: bold">{{$ticket}}</span>تیکت پشتیبانی</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('doc')}}">
                        <i class="icon-paper menu-icon"></i>
                        <span class="menu-title">جملات انگیزشی</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('allrep')}}">
                        <i class="icon-inbox menu-icon"></i>
                        <span class="menu-title">ریپلای ها</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('authentic')}}">
                        <i class="icon-target menu-icon"></i>
                        <span class="menu-title">اطلاعات احراز هویت</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('sendnews')}}">
                        <i class="icon-mail menu-icon"></i>
                        <span class="menu-title">ارسال خبرنامه</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('headers')}}">
                        <i class="icon-target menu-icon"></i>
                        <span class="menu-title">هدر</span>
                    </a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4 stretch-card transparent" style="margin-bottom: 0px">
                                <div class="card card-tale" style="border-radius: 0px">
                                    <div class="card-body">
                                        <p class="mb-4" style="font-size: 20px;text-align: right">عضویت خبرنامه</p>
...
<footer class="footer" style="direction: rtl;text-align: right">
    <div class="copyright">
        <strong> تمامی حقوق مادی و معنوی محتوای وبسایت برای مجموعه <span><a href="#">پاک وش </a>&copy;</span> محفوظ است. </strong>
    </div>
</footer>
</body>
